...
import me.jetcobblestone.util.packets.WrapperPlayServerScoreboardDisplayObjective;
import me.jetcobblestone.util.packets.WrapperPlayServerScoreboardObjective;
import me.jetcobblestone.util.packets.WrapperPlayServerScoreboardScore;
...
public class PacketBoard {
    ...
    public void removePlayer(Player player) {
        ...
        final List<UUID> receiver = List.of(player.getUniqueId());
    ...
    public void setSize(int size) {
        if (size > 16 || size < 0) {
            Bukkit.getLogger().severe("Attempted to set sidebar size to a value greater than 16 or less than 0");
            Thread.dumpStack();
            return;
        }
